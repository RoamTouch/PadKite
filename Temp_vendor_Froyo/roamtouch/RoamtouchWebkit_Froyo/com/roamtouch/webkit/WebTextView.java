...
import  roamtouch.graphics.ColorFilter;
import  roamtouch.graphics.Paint;
import  roamtouch.graphics.PixelFormat;
import  roamtouch.graphics.Rect;
import  roamtouch.graphics.drawable.Drawable;
import  roamtouch.text.Editable;
import  roamtouch.text.InputFilter;
import  roamtouch.text.Selection;
import  roamtouch.text.Spannable;
import  roamtouch.text.TextPaint;
import  roamtouch.text.TextUtils;
import  roamtouch.text.method.MovementMethod;
import  roamtouch.text.method.Touch;
import  roamtouch.util.Log;
import  roamtouch.view.Gravity;
import  roamtouch.view.KeyCharacterMap;
...
import  roamtouch.widget.AbsoluteLayout.LayoutParams;
import  roamtouch.widget.ArrayAdapter;
import  roamtouch.widget.AutoCompleteTextView;
import  roamtouch.widget.TextView;
