...
*/			break;
		case 9:
			alertDialog = new AlertDialog.Builder(MiscListActivity.this).create();
			alertDialog.getWindow().requestFeature(Window.FEATURE_NO_TITLE);
		    alertDialog.setMessage(Html.fromHtml("Engineering new standards in multi-touch technology, RoamingKeyboards LLC doing Business as RoamTouch� delivers innovative, hands-on, tactile applications for next-generation multi touch devices. For more information on Roamtouch�, visit <a href='http://www.roamtouch.com'>www.roamtouch.com</a>."));
		    alertDialog.setTitle("About RoamTouch�");
		    alertDialog.setButton("OK", new DialogInterface.OnClickListener() {
		      public void onClick(DialogInterface dialog, int which) {
		        return;
