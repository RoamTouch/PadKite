...
public class GestureEditor extends Activity implements OnItemClickListener{
	 ...
	 */
		...
		private int[] othergesturesImages= {R.drawable.ge_bookmark,R.drawable.ge_share,R.drawable.ge_gesture };
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if(position == cursorGestures.length+1){
		    	...
		    	tv.setHeight(60);
		    	tv.setPadding(5, 0, 0, 0);
				tv.setText("Circular Menu Gestures");
				tv.setTextColor(Color.WHITE);		
				tv.setBackgroundColor(Color.BLACK);
				tv.setGravity(Gravity.CENTER_VERTICAL);
				return tv; 
			 ...
			 //recordButton set position right on landscape
