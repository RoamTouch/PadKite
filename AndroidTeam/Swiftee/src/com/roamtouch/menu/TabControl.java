...
public class TabControl {
    ...
    //Window Tabs view containing various tabs
    private WindowTabs windowTabsView;
...
//                mActivity.switchToTab(getTabIndex(t));
     ...
     */
    public class Tab {
        // The Geo location permissions prompt
...
//            }
 ...
 //                       Context.LAYOUT_INFLATER_SERVICE));
	...
	public void setWindowTabsView(WindowTabs windowTabsView) {
		this.windowTabsView = windowTabsView;
	}

	public WindowTabs getWindowTabsView() {
		return windowTabsView;
	}
