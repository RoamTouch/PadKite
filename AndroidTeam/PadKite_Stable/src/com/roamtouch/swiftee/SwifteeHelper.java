...
public class SwifteeHelper {
	...
	private static String landingPath = Environment.getExternalStorageDirectory()+"/PadKite/WebAssets/loadPage";
	...
	public static String[] getHomepage(int init) {
		...
		if (init==0){
			String webPath = "file:////"+BrowserActivity.WEB_ASSETS_PATH + "/";
