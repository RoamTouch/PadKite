...
package com.roamtouch.gestures;
    ...
    private static class FileGestureLibrary extends GestureLibrary {
        ...
        public boolean save() {
            ...
            try {
                ...
                Log.d("", "Could not save the gesture library in " + mPath, e);
            } catch (IOException e) {
                Log.d("", "Could not save the gesture library in " + mPath, e);
            }
        ...
        public boolean load() {
            ...
            if (file.exists() && file.canRead()) {
                try {
                    ...
                    Log.d("", "Could not load the gesture library from " + mPath, e);
                } catch (IOException e) {
                    Log.d("", "Could not load the gesture library from " + mPath, e);
                }
            }
        ...
        public boolean load() {
            ...
            if (context != null) {
                ...
                try {
                    ...
                    Log.d("", "Could not load the gesture library from raw resource " +
